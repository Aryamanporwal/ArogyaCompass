...
import { getAttendanceByDoctorId } from "@/lib/actions/docattendance.action";
...
const DoctorAttendanceChart = ({ doctorId }: Props) => {
  ...
  // Aggregation logic (same as before, just without mark attendance part)
  ...
  // Daily summary for current month
  const now = new Date();
  ...
  return (
    <div className="bg-white dark:bg-[#1e1e1e] p-6 rounded-xl shadow-md w-full mx-auto mb-6">
...
export default DoctorAttendanceChart;
